...
class Plunag2copy extends CustomPainter {
  // final Animation<double> _animation;

  // Plunag2copy(this._animation) : super(repaint: _animation);
  @override
  void paint(Canvas canvas, Size size) {
    ...
    // final path = createAnimatedPath(path_0, 0.1);

    Paint paint0Fill = Paint()..style = PaintingStyle.stroke;
    paint0Fill.strokeJoin = StrokeJoin.round;
